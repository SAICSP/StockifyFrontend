    ...
    return ( 
        <div className="container mt-5">
            ...
            <div className="row mt-5">
                <div className="col ">
                    <h3 className="text-muted"><i class="fa-solid fa-circle-plus"></i> Account Opening</h3><br />
                ...
                <div className="col">
                    <h3 className="text-muted"> <i class="fa-solid fa-user"></i> Your Zerodha Account</h3><br />
                ...
                <div className="col">
                    <h3 className="text-muted"> <i class="fa-solid fa-chart-simple"></i> Trading and Markets</h3><br />
            ...
            <div className="row mt-5">
                <div className="col">
                    <h3 className="text-muted"><i class="fa-solid fa-money-check-dollar"></i> Funds</h3><br />
                ...
                <div className="col">
                    <h3 className="text-muted"><i class="fa-solid fa-display"></i> Console</h3><br />
                ...
                <div className="col">
                    <h3 className="text-muted"> <i class="fa-brands fa-bitcoin"></i> Coin</h3><br />
